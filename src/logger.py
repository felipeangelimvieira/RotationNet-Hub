# This code was copied from MrGemy95's tensorflow project template
# Link to this code: https://github.com/MrGemy95/Tensorflow-Project-Template/blob/master/utils/logger.py
